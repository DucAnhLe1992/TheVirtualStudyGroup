      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg max-w-2xl w-full p-6 my-8 transition-colors">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">Quiz Results</p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
            ...
            <p className="text-3xl font-bold text-blue-600 dark:text-blue-400">{bestScore}%</p>
          </div>
        ...
        <div>
          ...
          {attempts.length === 0 ? (
            <div className="text-center py-8 text-gray-500 dark:text-gray-400">No attempts yet</div>
          ) : (
            <div className="space-y-2 max-h-64 overflow-y-auto">
              {attempts.map((attempt, index) => (
                ...
                >
                  <div>
                    <p className="font-medium text-gray-900 dark:text-white">Attempt {attempts.length - index}</p>
