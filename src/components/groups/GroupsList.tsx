  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Study Groups</h2>
          <p className="text-gray-600 dark:text-gray-400 mt-1">Join or create groups to study together</p>
        </div>
        <button
      ...
      {activeView === 'my-groups' ? (
        groups.length === 0 ? (
          <div className="text-center py-12 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 transition-colors">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">Create or join a group to start studying together</p>
            <button
              onClick={() => setShowCreateModal(true)}
          ...
          {publicGroups.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {publicGroups.map((group) => (
                <div key={group.id} className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 hover:shadow-md transition-all">
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex-1">
                      <h3 className="font-semibold text-gray-900 dark:text-white text-lg mb-1">{group.name}</h3>
                      {group.subject && (
